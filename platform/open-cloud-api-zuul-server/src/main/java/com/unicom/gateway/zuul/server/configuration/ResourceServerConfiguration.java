package com.unicom.gateway.zuul.server.configuration;

import com.unicom.common.security.OpenHelper;
import com.unicom.gateway.zuul.server.exception.JsonAccessDeniedHandler;
import com.unicom.gateway.zuul.server.exception.JsonAuthenticationEntryPoint;
import com.unicom.gateway.zuul.server.exception.JsonSignatureDeniedHandler;
import com.unicom.gateway.zuul.server.filter.AccessManager;
import com.unicom.gateway.zuul.server.filter.PreCheckFilter;
import com.unicom.gateway.zuul.server.filter.PreRequestFilter;
import com.unicom.gateway.zuul.server.filter.PreSignatureFilter;
import com.unicom.gateway.zuul.server.service.AccessLogService;
import com.unicom.gateway.zuul.server.service.feign.BaseAppServiceClient;
